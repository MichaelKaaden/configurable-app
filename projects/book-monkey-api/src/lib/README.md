## @angular-schule/book-monkey-api@0.0.1
...
```
npm install @angular-schule/book-monkey-api@0.0.1 --save
```
...
import { ApiModule, Configuration } from '@angular-schule/book-monkey-api';
